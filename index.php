...
<div class="d-flex flex-column justify-content-center" style="min-height: 80vh;">
    ...
    <div class="row justify-content-center g-4">
        ...
        <div class="col-md-4 col-lg-3">
            <a href="modulos/vendas/vendas.php" class="card-menu">
        ...
        <div class="modal-content bg-dark text-white border-secondary shadow-lg">
            ...
            <div class="modal-body p-4">
                ...
                <div class="d-flex gap-3">
                    ...
                    <a href="modulos/pessoas/funcionarios/funcionarios.php" class="btn btn-outline-orange w-50 p-4 d-flex flex-column align-items-center justify-content-center">
