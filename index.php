...
<!-- Botão Sair: Agora aponta para modulos/logout.php -->
...
<div class="row justify-content-center g-4">
    ...
    <!-- Bloco 2: VENDAS -->
    <div class="col-md-4 col-lg-3">
        <!-- Agora aponta para modulos/breve.php -->
        <a href="modulos/breve.php" class="card-menu">
        ...
        <div class="modal-content bg-dark text-white border-secondary shadow-lg">
            ...
            <div class="modal-body p-4">
                ...
                <div class="d-flex gap-3">
                    ...
                    <a href="modulos/pessoas/clientes/cliente.php" class="btn btn-outline-orange w-50 p-4 d-flex flex-column align-items-center justify-content-center">
                    ...
                    <a href="modulos/breve.php" class="btn btn-outline-light w-50 p-4 d-flex flex-column align-items-center justify-content-center">
